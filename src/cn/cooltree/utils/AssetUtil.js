class AssetUtil
{
	...
	static parseFont(fnt)
	{
		...
		let xmlDoc=URLLoader.parseXML(fnt,"text/xml");
		let info=xmlDoc.getElementsByTagName("info")[0];
		let common=xmlDoc.getElementsByTagName("common")[0];
		let pnode=xmlDoc.getElementsByTagName("pages");
		...
		let pages=pnode[0].childNodes;
		let chars =xmlDoc.getElementsByTagName("chars")[0].childNodes;
