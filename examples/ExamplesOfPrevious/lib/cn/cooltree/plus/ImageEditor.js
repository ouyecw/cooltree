...
Global.inherit(ImageEditor, DisplayObjectContainer);

Object.defineProperty(ImageEditor.prototype,"target",{
	get: function (){
		return this._target;
	},
    set: function (value) {
...
ImageEditor.prototype.init=function(image,imgw,imgh,width,height,alpha)
{
...
ImageEditor.prototype.resizeFrame=function(w,h)
{
	var first=(this.width==0 && this.height==0);
 ...
 */
ImageEditor.prototype.screenshot=function(type)
{
	if(this._target==null || this.width==0 || this.height==0) return null;
	var point,obj=CanvasUtil.create();
	...
	if(Global.useCanvas){
		...
		var mtx=this._target.getMatrix(this._container,true);
...
ImageEditor.prototype.dispose=function()
{
	ImageEditor.superClass.dispose.call(this);
