...
Global.inherit(BDMap,EventDispatcher);
 ...
 */
BDMap.prototype.init=function(version,key,hideLogo,options,server)
{
	var _this=this;
...
BDMap.prototype._init_map=function()
{
	...
	if(this.options.scale_control){
		var scaleControl = new BMap.ScaleControl({anchor:this.options.scale_control.pos,offset:new BMap.Size(this.options.scale_control.offset.x,this.options.scale_control.offset.y)});
	    scaleControl.setUnit(this.options.scale_control.unit);
	    this.map.addControl(scaleControl);
	}
	
	if(this.options.navigation_control){
		var navControl = new BMap.NavigationControl({anchor:this.options.navigation_control.pos,offset:new BMap.Size(this.options.navigation_control.offset.x,this.options.navigation_control.offset.y),type:this.options.navigation_control.type});
	    this.map.addControl(navControl);
	}
	
	if(this.options.minmap_control){
		var overviewControl = new BMap.OverviewMapControl({anchor:this.options.minmap_control.pos,offset:new BMap.Size(this.options.minmap_control.offset.x,this.options.minmap_control.offset.y),isOpen:this.options.minmap_control.open});
	    this.map.addControl(overviewControl);
	}
	
	if(this.options.geolocation_control){
		var icon=(this.options.geolocation_control.icon=="" || this.options.geolocation_control.icon==null) ? null : new BMap.Icon(this.options.geolocation_control.icon,this.options.geolocation_control.size ? new BMap.Size(this.options.geolocation_control.size.w,this.options.geolocation_control.size.h) :null);
		var geolocationControl = new BMap.GeolocationControl({anchor:this.options.minmap_control.pos,offset:new BMap.Size(this.options.geolocation_control.offset.x,this.options.geolocation_control.offset.y),showAddressBar:this.options.geolocation_control.display,enableAutoLocation:this.options.geolocation_control.auto,locationIcon:icon});
...
BDMap.prototype._add_event=function(m,w,s,i)
{
...
BDMap.prototype.changeIndex=function(index)
{
...
BDMap.prototype.getDefaultOptions=function()
{
	var opt={};
