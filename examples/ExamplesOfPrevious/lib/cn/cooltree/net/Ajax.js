 ...
 */
Ajax.prototype.get = function (url, data, oncomplete, onerror,use_form_data,async) 
{
 ...
 * @param {Boolean} async true为同步
 */
Ajax.prototype.post = function (url, data, oncomplete, onerror,use_form_data,async) 
{
...
Ajax.prototype.getRequest = function (t, url, d, oncomplete, err,use_form_data,async) 
{
