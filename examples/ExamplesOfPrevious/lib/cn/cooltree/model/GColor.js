...
function GColor(type,xStart, yStart, xEnd, yEnd, offsetlist, colorList, radiusStart, radiusEnd)
{
	this.setup(type,xStart, yStart, xEnd, yEnd, offsetlist, colorList, radiusStart, radiusEnd);
}

GColor.prototype.__class__="GColor";
 ...
 */
GColor.prototype.setup=function(type,xStart, yStart, xEnd, yEnd, offsetlist, colorList, radiusStart, radiusEnd)
{
	this.type=type;
	this.xStart=xStart;
	this.yStart=yStart;
...
GColor.prototype.dispose=function()
{
