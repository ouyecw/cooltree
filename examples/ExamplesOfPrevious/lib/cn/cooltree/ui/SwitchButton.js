...
Global.inherit(SwitchButton,DisplayObjectContainer);
...
SwitchButton.prototype.setup=function(config)
{
	...
	this.bar.origin.set(this.redius,this.redius);
...
SwitchButton.prototype.change_handler=function(e)
{
	if(this.lock) return;
	this.value=!this.bool;
}

SwitchButton.prototype.mouse_handler=function(e)
{
...
SwitchButton.prototype.mouse_move=function(e)
{
...
SwitchButton.prototype.mouse_up=function(e)
{
...
SwitchButton.prototype._change_middle=function()
{
	this.middle.width=this.redius+this.bar.x+this.space;
}

SwitchButton.prototype.sync_data=function(use_tween)
{
...
SwitchButton.prototype.reset=function()
{
	...
	SwitchButton.superClass.reset.call(this);
}
...
SwitchButton.prototype.dispose=function()
{
	...
	SwitchButton.superClass.dispose.call(this);
