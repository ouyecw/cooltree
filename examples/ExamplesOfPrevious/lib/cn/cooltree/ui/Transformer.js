...
Transformer.prototype.update_relative_data=function(bool)
{
...
Transformer.prototype.sync_display=function()
{
	if(!this._target || !this._target.parent) return;
...
Transformer.prototype._update_target_size=function()
{
...
Transformer.prototype._mouse_wheel_handle=function(e)
{
...
Transformer.prototype._key_up=function(e)
{
...
Transformer.prototype._key_down=function(e)
{
...
Transformer.prototype._drag_mouse_down=function(e)
{
	...
	if(this.support_finger && this._double_finger){
		...
		this._finger_center=new Point((this._point1.mouseX+this._point2.mouseX)*0.5,(this._point1.mouseY+this._point2.mouseY)*0.5);
...
Transformer.prototype._drag_mouse_move=function(e)
{
	...
	cen = this._canvas.localToGlobal(this._finger_center);
...
Transformer.prototype._trans_mouse_move=function(e)
{
	...
	this._btn.moveTo(!this.rotate || offX==this._min_scale || offY==this._min_scale ? this.globalToLocal(this._canvas.localToGlobal(this._point)) : this.globalToLocal(e.mouseX, e.mouseY));
...
Transformer.prototype._clear_transformer=function()
{
	if(this._canvas) {
		if( this.contains(this._canvas))this._canvas.removeFromParent(false);
	 	...
	 	if(Global.os==SystemType.OS_PC && this.wheel_control) 
	...
	if(Global.os==SystemType.OS_PC && this.key_control && (this.stage ? this.stage : Stage.current).hasEventListener(StageEvent.KEY_DOWN,this.name)){
