window.onload = function()
{
	...
	//新建一个加载组件
	const clip=new LoadingClip("img/buffer.png");
	...
	//加载文件路径
	loader.load(["img/tu.png","img/anim.png","img/anim.json"]);
}
...
function loadComplete(e)
{
	...
	//按钮设置特效
	btn.setup([Factory.c("ef",[Effect.COLOR,"#ff88ff",0.5])],[Factory.c("ef",[Effect.COLOR,"#ff8800",1])],[Factory.c("ef",[Effect.COLOR,"#ff5555",1])]);
...
function click_handler(e)
{
	...
	//新建动画实例
	const mc=MovieManager.getInstance(anims[MathUtil.randomInt(len)],"Zombie_ladder");
