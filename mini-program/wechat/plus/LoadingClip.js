...
export default class LoadingClip extends DisplayObjectContainer
{
	...
	setup(url,cb=null)
	{
		...
		this._img=Global.stage?.canvas.createImage();
	...
	//	this.stop();
		...
		TweenLite.to(this._instance,this.speed,{rotation:360,onComplete:this._loop,ease:"linear"});
	}
