...
GraphicsVO.LIST=['arc','moveTo','lineTo','beginPath','closePath','bezierCurveTo','curveTo','lineStyle','clear','beginFill','endFill','beginBitmapFill','linearGradientFill','radialGradientFill','drawRect','drawRoundRect','drawPath','drawCircle','drawEllipse','createPolygon','drawSVGPath','drawShape','dispose','drawSpecialRect','clearRect'];
