...
export default class ScrollTouchList extends Sprite
{
	...
	//  this.addChild(line);
	    ...
	    this.on(StageEvent.MOUSE_DOWN,this.onMouseDown,this);
	    this.on(StageEvent.MOUSE_WHEEL,this.onMouseWheel,this);
	}
	...
	onMouseDown(e)
	{
		...
		this.stage.on(StageEvent.MOUSE_MOVE,this.onMouseMove,this,this.name);
		this.stage.on(StageEvent.MOUSE_UP,this.onMouseUp,this,this.name);
	}
	...
	_create_list()
	{
		...
		for(i=0;i<len;i++){
			...
			item.index=i;
			item.on(StageEvent.MOUSE_TAP,this.onMouseTap,this);
		}
...
module.exports = ScrollTouchList;