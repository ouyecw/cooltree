...
//  	this.emit(new Event(MoveBar.CHANGE,this._value));
	...
	_activate_bar(bool)
	{
		...
		if(bool){
			this.bar.on(StageEvent.MOUSE_DOWN,this._mouse_down_bar, this);
			if(this.bottom.alpha>0 && this.bottom.visible) this.bottom.on(StageEvent.MOUSE_DOWN,this._mouse_move_handler, this);
			return;
		}
	...
	_mouse_down_bar(e)
	{
		...
		(this.stage ? this.stage : Global.stage).on(StageEvent.MOUSE_MOVE,this._mouse_move_handler, this,this.name);
		(this.stage ? this.stage : Global.stage).on(StageEvent.MOUSE_UP,this._mouse_up_bar, this,this.name);
	}
	...
	_mouse_move_handler(e)
	{
		...
		let pos=this.globalToLocal((e ? e.mouseX : (this.stage ? this.stage : Global.stage).mouseX)-(offset ? offset.x : 0),(e ? e.mouseY : (this.stage ? this.stage : Global.stage).mouseY)-(offset ? offset.y : 0))
