...
export default class Button extends DisplayObjectContainer
{
	...
	{
		if(this.frames==undefined || obj==undefined || StringUtil.isEmpty(label) || (!(obj instanceof Source) && !ClassUtil.isImage(obj) &&!(obj instanceof DisplayBase) && !(obj instanceof Effect) && !(obj instanceof Array))) return;
	    ...
	    if(obj instanceof Source || ClassUtil.isImage(obj)){
