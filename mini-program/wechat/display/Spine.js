...
import spine from '../libs/spine-core.js'
...
export default class Spine extends DisplayBase
{
     ...
     */
	//当前动画播放进度百分比改变时触发
    static CHANGE="playChange";

	//动画开始时触发
    static START="playStart";

	//当不再应用某个动画时触发
	static OVER="playOver";

	//当动画完成循环时触发
	static COMPLETE="playComplete";

	//当清除了某条动画轨道或设置了某个新动画时触发
	static INTERERRUPT="interrupt";
