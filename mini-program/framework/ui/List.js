...
export default class List extends DisplayObjectContainer
{
	constructor()
	{
		...
		this.control=this._selected=this.container=this.tf_obj=this._datas=null;
	}
	...
	set data(value) 
	{
       ...
       if(!this.container){
       	  ...
       	  if(Global.isPC && this.useWheel) {
       	  	...
       	  	this.container.on(StageEvent.MOUSE_WHEEL,this._mouse_wheel,this);
       	  }
       }
	...
	addItem  (data)
	{
		...
		item.on(StageEvent.MOUSE_TAP,this._click_item,this);
	}
	...
	dispose()
	{
		this.clear();
		super.dispose();
		delete this.speed,this.useWheel,this.disable_ft_color,this.over_ft_color,this.line_color,this.disable_color,this.over_color,this.bg_color,this.canPush,this.item_height,this.w,this.h,this.control,this._selected,this.container,this.tf_obj,this._datas;
	}
}
