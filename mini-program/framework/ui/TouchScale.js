...
export default class TouchScale extends DisplayObjectContainer
{
	...
	_init_transformer()
	{
	    ...
	    if(this.wheel) this._canvas.on(StageEvent.MOUSE_WHEEL, this._mouse_wheel_handle,this,this.name);
	}
	...
	_drag_mouse_down(e)
	{
		...
		if(this._double_finger){
			...
			(this.stage ? this.stage : Global.stage).startDrag(this._canvas,this.limit_rect ? this._count_limit_area() : null);
	...
	_drag_mouse_up(e)
	{
		if(!this._double_finger) (this.stage ? this.stage : Global.stage).stopDrag();
...
TouchScale.className="TouchScale";
module.exports = TouchScale;